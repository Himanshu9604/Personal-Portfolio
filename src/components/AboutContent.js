            ...
            >
             ...
             {/* about */}
              ...
              <div className={toggleTab === 1 ? 'content active-content' : 'content'}>
                <h2>Who am I?</h2>
                <p>
Greetings, Himanshu Yadav It gives me great pleasure to make your acquaintance! At just 22 years old, I hail from the beautiful city of Amravati, Maharashtra, and hold a Bachelor's degree in Engineering.. 
<p className='content-heading-two'> I am ambitious and optimistic nature fuels and motivation, and I aspire to contribute my skills and passion to the IT industry. Proficient in HTML, CSS, JavaScript, and React, I possess a strong foundation to create remarkable work</p></p>
                <br/>
                
                <span>After graduating with a BE degree However, my passion for problem-solving persisted, leading me to discover the world of tech industries and their workings. While browsing numerous skill-building websites and watching countless tutorial videos, I felt overwhelmed and directionless. But joining the FunctionUp bootcamp turned out to be my best decision so far.</span>
              </div>
