          ...
          <div className="coloum">
            ...
            <div className="tab-content">
              ...
              >
                <h2>Who am I?</h2>
                <p>
                  Greetings, Himanshu Yadav It gives me great pleasure to make
                  your acquaintance! At just 22 years old, I hail from the
                  beautiful city of Amravati, Maharashtra, and hold a Bachelor's
                ...
                <span>
                  After graduating with a BE degree However, my passion for
              ...
              >
                ...
                <div className="exp-coloum">
                  <h3>FunctionUp (Teaching Assistant-TA)</h3>
                  <span className="exp-loc">-Bengaluru, Karnataka</span>
                  <span className="exp-dur">Feb 2023 - present</span>
                  <ul className="exp-info">
                    <li>
